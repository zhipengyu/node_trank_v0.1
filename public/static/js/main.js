!
    function(e) {
        ...
        function a() {
            ...
            function() {
                if (!i()) {
                    if (a() && window.SOHUZ) return void(window.location = "/homepage/support-mobile?site_id=" + SOHUZ.page.site_id + "&url=" + encodeURIComponent(window.location));
                    n(1);
                    var e = n(6);
                    n(7), n(8);
                    var t = new e;
        ...
        i.fn("init", function(e) {
            if (!window.qiao || "object" != typeof window.qiao) {
                var t = this;
                this.$html.addClass("kz-pc"), this.$body.prepend("<div class='kz-pc-loading'><span></span></div><div style='display: none' class='kz-pc-header kz-b-c-t kz-f-c-tc'><div class='kz-pc-header-inner'><a data-pc-logo></a><a data-pc-title></a><span data-pc-menu></span></div></div>"), this.$logo_wrapper = this.$body.find("[data-pc-logo]"), this.$loading = this.$body.find(".kz-pc-loading"), this.$title_wrapper = this.$body.find("[data-pc-title]"), this.$menu_wrapper = this.$body.find("[data-pc-menu]"), this.$nav_wrapper = this.$body.find(".kz-pc-side-nav"), this.$header = this.$body.find(".kz-pc-header"), e.logo ? (this.$logo_wrapper.html("<img src='" + e.logo + "'>").attr("href", e.home_url), this.$logo_wrapper.find("img").one("load", function() {
                    t.$title_wrapper.css({
                        "max-width": 336 - t.$logo_wrapper.width()
                    })
                })) : (this.$logo_wrapper.hide(), this.$header.addClass("no-logo")), $(document).on("scroll", function() {
