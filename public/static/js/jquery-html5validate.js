	...
	if(lang=='USD' || lang == 'SGD' || lang =='MYR') {
        OBJREG = {
            ...
            "prompt": {
                ...
                checkbox: "Check this box if you want to continue",
                "select": "Please select one of the items in the list",
                email: "Please enter an email address",
                url: "Please enter the website address",
                tel: "Please enter the phone number",
				telp: "Please enter the correct phone number",
                number: "Please enter a value",
                date: "Please enter the date",
                pattern: "Content format does not meet the requirements",
                empty: "Please fill in this field",
                multiple: "Multiple pieces of data separated by commas"
            }
        };
    }else if(lang == 'THB'){
        OBJREG = {
            ...
            ZIPCODE: "^\\d{6}$",
            "prompt": {
                radio: "โปรดเลือกตัวเลือก",
                checkbox: "เลือกช่องนี้หากคุณต้องการดำเนินการต่อ",
                "select": "โปรดเลือกหนึ่งในรายการในรายการ",
                email: "โปรดป้อนที่อยู่อีเมล",
                url: "โปรดป้อนที่อยู่เว็บไซต์",
                tel: "โปรดป้อนหมายเลขโทรศัพท์มือถือของคุณ",
				telp : "กรุณาใส่หมายเลขโทรศัพท์ที่ถูกต้อง(010-12345678)",
                number: "โปรดป้อนค่า",
                date: "โปรดป้อนวันที่",
                pattern: "รูปแบบเนื้อหาไม่เป็นไปตามข้อกำหนด",
                empty: "โปรดกรอกข้อมูลในช่องนี้",
                multiple: "ข้อมูลหลายชิ้นคั่นด้วยเครื่องหมายจุลภาค"
            }
        };
	}else{
        OBJREG = {
