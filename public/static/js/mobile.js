(function(g) {
    ...
    g.SOHUZ.CONF = {
        url_api: "https://shop.qoasec.com",
        url_res: "//shop.qoasec.com",
        url_pfile: "//shop.qoasec.com",
        url_passport: "https://shop.qoasec.com",
        url_v2: "https://shop.qoasec.com/v2"
    }
})(window);
(function($, g) {
    if (!g.postAdInfo) {
    ...
    Z.isApp = function() {
        var ua = navigator.userAgent,
            is_ios = /KuaiZhaniOSSite/gi.test(ua),
            is_android = /KuaiZhanAndroidWrapper/gi.test(ua);
        return is_ios || is_android
    };
    Z.isManageApp = function() {
        return navigator.userAgent.match(/KuaiZhan(iOSManager|AndroidManager)/i)
    };
    n.winWidth = function() {
    ...
    if (/Android|webOS|iPhone|iPad|iPod|BlackBerry|BB|PlayBook|IEMobile|Windows Phone|Kindle|Silk|Opera Mini/i.test(navigator.userAgent) && SOHUZ.page && SOHUZ.page.page_type != 4) {
        if (window.require) {
            var toolbar_url = "/res/site/js/mobile-manage-toolbar.js";
            require([SOHUZ.CONF.url_res + toolbar_url], function(manage) {})
        }
    }
})(Zepto, this);
(function($, g) {
...
/*        $("#phone-main .phone-header").on("click", ".site-title", function() {
            ...
            if (tn.hasClass("mod-themenav4")) {
                ...
                if (len > 5) {
                    var d = $('<div class="dropbox">' + "<ul></ul>" + '<span class="ico-arrow"><em class="ico-arrow-bd"></em><em class="ico-arrow-bg"></em></span>' + "</div>"),
                        more = tn.hasClass("mod-themenav2") ? $('<li class="more"><a href="javascript:void(0);"><p class="font-ico"><i></i><i></i><i></i></p><p class="title">更多</p></a></li>') : $('<li class="more"><a href="javascript:;"><i></i><i></i><i></i></a></li>');
        ...
        if (/Android|webOS|iPhone|iPad|iPod|BlackBerry|BB|PlayBook|IEMobile|Windows Phone|Kindle|Silk|Opera Mini/i.test(navigator.userAgent) && window.require) {
            require(["res/mobile/js/img-viewer"], function(img_viewer) {
