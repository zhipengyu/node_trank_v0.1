 var Carrier=[
	...
	["412", "20", "af", "Afghanistan", "93", "Roshan/TDCA  "],
	["412", "03", "af", "Afghanistan", "93", "WaselTelecom (WT) "],
	["276", "01", "al", "Albania", "355", "AMC/Cosmote "],
	...
	["344", "930", "ag", "Antigua and Barbuda", "1268", "DigiCel/Cing. Wireless "],
	...
	["722", "340", "ar", "Argentina Republic", "54", "Telecom Personal S.A. "],
	...
	["232", "12", "at", "Austria", "43", "3/Orange/One Connect "],
	["232", "05", "at", "Austria", "43", "3/Orange/One Connect "],
	["232", "06", "at", "Austria", "43", "3/Orange/One Connect "],
	["232", "17", "at", "Austria", "43", "Spusu/Mass Response "],
	["232", "03", "at", "Austria", "43", "T-Mobile/Telering "],
	["232", "07", "at", "Austria", "43", "T-Mobile/Telering "],
	["232", "04", "at", "Austria", "43", "T-Mobile/Telering "],
	["232", "19", "at", "Austria", "43", "Tele2 "],
	["232", "08", "at", "Austria", "43", "A1 MobilKom "],
	["232", "13", "at", "Austria", "43", "UPC Austria "],
	...
	["470", "03", "bd", "Bangladesh", "880", "Orascom/Banglalink "],
	["470", "04", "bd", "Bangladesh", "880", "TeleTalk "],
	["470", "07", "bd", "Bangladesh", "880", "Airtel/Warid "],
	["342", "600", "bb", "Barbados", "1246", "LIME "],
	...
	["736", "01", "bo", "Bolivia", "591", "Viva/Nuevatel "],
	...
	["528", "02", "bn", "Brunei Darussalam", "673", "b-mobile "],
	["528", "11", "bn", "Brunei Darussalam", "673", "Datastream (DTSCom) "],
	["528", "01", "bn", "Brunei Darussalam", "673", "Telekom Brunei Bhd (TelBru) "],
	["284", "06", "bg", "Bulgaria", "359", "BTC Mobile EOOD (vivatel) "],
	["284", "03", "bg", "Bulgaria", "359", "BTC Mobile EOOD (vivatel) "],
	["284", "05", "bg", "Bulgaria", "359", "Telenor/Cosmo/Globul "],
	...
	["642", "08", "bi", "Burundi", "257", "Lumitel/Viettel "],
	["642", "03", "bi", "Burundi", "257", "Onatel / Telecel  "],
	["642", "07", "bi", "Burundi", "257", "Smart Mobile / LACELL  "],
	["642", "82", "bi", "Burundi", "257", "Spacetel / Econet / Leo  "],
	["642", "01", "bi", "Burundi", "257", "Spacetel / Econet / Leo  "],
	["456", "04", "kh", "Cambodia", "855", "Cambodia Advance Communications Co. Ltd (CADCOMMS) "],
	["456", "02", "kh", "Cambodia", "855", "Smart Mobile "],
	["456", "08", "kh", "Cambodia", "855", "Metfone "],
	["456", "18", "kh", "Cambodia", "855", "MFone/Camshin/Cellcard "],
	...
	["456", "09", "kh", "Cambodia", "855", "Sotelco/Beeline "],
	...
	["302", "780", "ca", "Canada", "1", "Sask Tel Mobility "],
	...
	["622", "01", "td", "Chad", "235", "Airtel/ZAIN/Celtel "],
	...
	["730", "10", "cl", "Chile", "56", "Entel Telefonia "],
	...
	["730", "19", "cl", "Chile", "56", "Sociedad Falabella Movil SPA "],
	...
	["630", "90", "cd", "Congo, Dem. Rep.", "243", "Africell "],
	...
	["630", "02", "cd", "Congo, Dem. Rep.", "243", "Airtel/ZAIN "],
	["629", "01", "cg", "Congo, Republic", "242", "Airtel SA "],
	["629", "02", "cg", "Congo, Republic", "242", "Azur SA (ETC) "],
	...
	["740", "01", "ec", "Ecuador", "593", "Claro/Porta"],
	["602", "01", "eg", "Egypt", "20", "Orange/Mobinil "],
	...
	["208", "17", "fr", "France", "33", "Legos - Local Exchange Global Operation Services SA "],
	...
	["262", "42", "de", "Germany", "49", "Vodafone D2 "],
	...
	["202", "14", "gr", "Greece", "30", "CyTa Mobile "],
	...
	["340", "08", "gp", "Guadeloupe ", "590", "Dauphin Telecom SU (Guadeloupe Telecom) "],
	...
	["611", "04", "gn", "Guinea", "224", "MTN/Areeba "],
	["611", "05", "gn", "Guinea", "224", "Celcom "],
	["611", "03", "gn", "Guinea", "224", "Intercel "],
	["611", "01", "gn", "Guinea", "224", "Orange/Sonatel/Spacetel "],
	...
	["708", "040", "hn", "Honduras", "504", "Digicel "],
	["708", "030", "hn", "Honduras", "504", "HonduTel "],
	["708", "001", "hn", "Honduras", "504", "SERCOM/CLARO "],
	["708", "002", "hn", "Honduras", "504", "Telefonica/CELTEL "],
	["454", "13", "hk", "Hongkong, China", "852", "China Mobile/Peoples "],
	["454", "12", "hk", "Hongkong, China", "852", "China Mobile/Peoples "],
	["454", "28", "hk", "Hongkong, China", "852", "China Mobile/Peoples "],
	...
	["454", "08", "hk", "Hongkong, China", "852", "Truephone "],
	...
	["404", "10", "in", "India", "91", "Bharti Airtel Limited (Delhi) "],
	["404", "045", "in", "India", "91", "Bharti Airtel Limited (Karnataka) (India) "],
	...
	["405", "034", "in", "India", "91", "TATA / Karnataka "],
	["404", "30", "in", "India", "91", "Usha Martin Telecom "],
	["510", "08", "id", "Indonesia", "62", "Axis/Natrindo "],
	["510", "99", "id", "Indonesia", "62", "Esia (PT Bakrie Telecom) (CDMA) "],
	["510", "07", "id", "Indonesia", "62", "Flexi (PT Telkom) (CDMA) "],
	...
	["418", "20", "iq", "Iraq", "964", "ZAIN/Atheer/Orascom "],
	...
	["272", "05", "ie", "Ireland", "353", "Three/H3G "],
	["272", "11", "ie", "Ireland", "353", "Tesco Mobile/Liffey Telecom "],
	["272", "13", "ie", "Ireland", "353", "Lycamobile "],
	["272", "03", "ie", "Ireland", "353", "Meteor Mobile Ltd. "],
	["272", "02", "ie", "Ireland", "353", "Three/O2/Digifone "],
	...
	["425", "19", "il", "Israel", "972", "Telzar/AZI  "],
	["222", "34", "it", "Italy", "39", "BT Italia SpA "],
	["222", "02", "it", "Italy", "39", "Elsacom "],
	["222", "08", "it", "Italy", "39", "Fastweb SpA "],
	["222", "00", "it", "Italy", "39", "Fix Line "],
	...
	["222", "33", "it", "Italy", "39", "PosteMobile SpA "],
	["222", "00", "it", "Italy", "39", "Premium Number(s) "],
	...
	["440", "20", "jp", "Japan", "81", "SoftBank Mobile Corp "],
	...
	["639", "03", "ke", "Kenya", "254", "Airtel/Zain/Celtel Ltd. "],
	...
	["457", "08", "la", "Laos P.D.R.", "856", "Beeline/Tigo/Millicom "],
	...
	["415", "37", "lb", "Lebanon", "961", "MIC2/LibanCell/MTC "],
	["415", "39", "lb", "Lebanon", "961", "MIC2/LibanCell/MTC "],
	["415", "38", "lb", "Lebanon", "961", "MIC2/LibanCell/MTC "],
	["415", "01", "lb", "Lebanon", "961", "MIC1 (Alfa) "],
	["415", "03", "lb", "Lebanon", "961", "MIC2/LibanCell/MTC "],
	["415", "36", "lb", "Lebanon", "961", "MIC2/LibanCell/MTC "],
	["651", "02", "ls", "Lesotho", "266", "Econet/Ezi-cel "],
	["651", "01", "ls", "Lesotho", "266", "Vodacom Lesotho "],
	["618", "07", "lr", "Liberia", "231", "CELLCOM "],
	...
	["295", "05", "li", "Liechtenstein", "423", "Telecom FL1 AG "],
	...
	["270", "01", "lu", "Luxembourg", "352", "P+T/Post LUXGSM "],
	["270", "99", "lu", "Luxembourg", "352", "Orange/VOXmobile S.A. "],
	...
	["650", "10", "mw", "Malawi", "265", "Airtel/Zain/Celtel ltd. "],
	...
	["502", "153", "my", "Malaysia", "60", "Webe/Packet One Networks (Malaysia) Sdn Bhd "],
	["502", "155", "my", "Malaysia", "60", "Samata Communications Sdn Bhd "],
	["502", "154", "my", "Malaysia", "60", "Tron/Talk Focus Sdn Bhd "],
	["502", "18", "my", "Malaysia", "60", "U Mobile "],
	["502", "195", "my", "Malaysia", "60", "XOX Com Sdn Bhd "],
	["502", "152", "my", "Malaysia", "60", "YES "],
	["472", "01", "mv", "Maldives", "960", "Dhiraagu/C&amp;W "],
	["472", "02", "mv", "Maldives", "960", "Ooredo/Wataniya "],
	...
	["414", "01", "mm", "Myanmar (Burma)", "95", "Myanmar Post &amp; Teleco. "],
	["414", "05", "mm", "Myanmar (Burma)", "95", "Oreedoo "],
	["414", "06", "mm", "Myanmar (Burma)", "95", "Telenor "],
	...
	["530", "05", "nz", "New Zealand", "64", "Spark/NZ Telecom "],
	["530", "02", "nz", "New Zealand", "64", "Spark/NZ Telecom "],
	...
	["614", "03", "ne", "Niger", "227", "MOOV/TeleCel "],
	["614", "04", "ne", "Niger", "227", "Orange/Sahelc. "],
	["614", "01", "ne", "Niger", "227", "Orange/Sahelc. "],
	["614", "02", "ne", "Niger", "227", "Airtel/Zain/CelTel "],
	...
	["242", "14", "no", "Norway", "47", "ICE Nordisk Mobiltelefon AS "],
	...
	["242", "017", "no", "Norway", "47", "Ventelo AS "],
	...
	["714", "01", "pa", "Panama", "507", "Cable &amp; W./Mas Movil "],
	...
	["716", "17", "pe", "Peru", "51", "Nextel "],
	["716", "15", "pe", "Peru", "51", "Viettel Mobile "],
	...
	["268", "07", "pt", "Portugal", "351", "NOS/Optimus "],
	["268", "03", "pt", "Portugal", "351", "NOS/Optimus "],
	["268", "06", "pt", "Portugal", "351", "MEO/TMN "],
	["268", "01", "pt", "Portugal", "351", "Vodafone "],
	["330", "11", "pr", "Puerto Rico", "", "Puerto Rico Telephone Company Inc. (PRTC) "],
	["330", "110", "pr", "Puerto Rico", "", "Puerto Rico Telephone Company Inc. (PRTC) "],
	["427", "01", "qa", "Qatar", "974", "Ooredoo/Qtel "],
	...
	["250", "35", "ru", "Russian Federation", "79", "MOTIV/LLC Ekaterinburg-2000 "],
	...
	["250", "99", "ru", "Russian Federation", "79", "BeeLine/VimpelCom "],
	...
	["608", "02", "sn", "Senegal", "221", "TIGO/Sentel GSM "],
	...
	["619", "01", "sl", "Sierra Leone", "232", "Airtel/Zain/Celtel "],
	...
	["293", "70", "si", "Slovenia", "386", "Telemach/TusMobil/VEGA "],
	...
	["659", "03", "ss", "South Sudan (Republic of)", "", "Gemtel Ltd (South Sudan "],
	["659", "02", "ss", "South Sudan (Republic of)", "", "MTN South Sudan (South Sudan "],
	["659", "04", "ss", "South Sudan (Republic of)", "", "Network of The World Ltd (NOW) (South Sudan "],
	["659", "06", "ss", "South Sudan (Republic of)", "", "Zain South Sudan (South Sudan "],
	["214", "23", "es", "Spain", "34", "Lycamobile SL "],
	["214", "22", "es", "Spain", "34", "Digi Spain Telecom SL "],
	...
	["466", "89", "tw", "Taiwan", "886", "T-Star/VIBO "],
	...
	["640", "09", "tz", "Tanzania", "255", "Halotel/Viettel Ltd "],
	...
	["640", "05", "tz", "Tanzania", "255", "Airtel/ZAIN/Celtel "],
	...
	["374", "120", "tt", "Trinidad and Tobago", "1868", "Bmobile/TSTT "],
	["374", "12", "tt", "Trinidad and Tobago", "1868", "Bmobile/TSTT "],
	...
	["605", "06", "tn", "Tunisia", "216", "TuniCell/Tunisia Telecom "],
	...
	["438", "01", "tm", "Turkmenistan", "993", "MTS/Barash Communication "],
	["438", "02", "tm", "Turkmenistan", "993", "Altyn Asyr/TM-Cell "],
	["376", "350", "tc", "Turks and Caicos Islands", "", "Cable &amp; Wireless (TCI) Ltd "],
	["376", "050", "tc", "Turks and Caicos Islands", "", "Digicel TCI Ltd "],
	["376", "352", "tc", "Turks and Caicos Islands", "", "IslandCom Communications Ltd. "],
	["553", "01", "tv", "Tuvalu", "", "Tuvalu Telecommunication Corporation (TTC) "],
	["641", "01", "ug", "Uganda", "256", "Airtel/Celtel "],
	...
	["234", "20", "gb", "United Kingdom", "44", "H3G Hutchinson "],
	["234", "94", "gb", "United Kingdom", "44", "H3G Hutchinson "],
	...
	["234", "57", "gb", "United Kingdom", "44", "Sky UK Limited "],
	...
	["312", "090", "us", "United States", "1", "Allied Wireless Communications Corporation "],
	...
	["311", "410", "us", "United States", "1", "Iowa RSA No. 2 Limited Partnership "],
	...
	["310", "670", "us", "United States", "1", "Northstar "],
	...
	["310", "950", "us", "United States", "1", "Unknown "],
